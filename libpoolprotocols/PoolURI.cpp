...
static std::map<std::string, SchemeAttributes> s_schemes = {
	{"vtratum+tcp",	  {ProtocolFamily::STRATUM, SecureLevel::NONE,  0}},
	{"vtratum1+tcp",  {ProtocolFamily::STRATUM, SecureLevel::NONE,  1}},
	{"vtratum2+tcp",  {ProtocolFamily::STRATUM, SecureLevel::NONE,  2}},
	{"vtratum+tls",	  {ProtocolFamily::STRATUM, SecureLevel::TLS,   0}},
	{"vtratum1+tls",  {ProtocolFamily::STRATUM, SecureLevel::TLS,   1}},
	{"vtratum2+tls",  {ProtocolFamily::STRATUM, SecureLevel::TLS,   2}},
	{"vtratum+tls12", {ProtocolFamily::STRATUM, SecureLevel::TLS12, 0}},
	{"vtratum1+tls12",{ProtocolFamily::STRATUM, SecureLevel::TLS12, 1}},
	{"vtratum2+tls12",{ProtocolFamily::STRATUM, SecureLevel::TLS12, 2}},
	{"vtratum+ssl",	  {ProtocolFamily::STRATUM, SecureLevel::TLS12, 0}},
	{"vtratum1+ssl",  {ProtocolFamily::STRATUM, SecureLevel::TLS12, 1}},
	{"vtratum2+ssl",  {ProtocolFamily::STRATUM, SecureLevel::TLS12, 2}},
